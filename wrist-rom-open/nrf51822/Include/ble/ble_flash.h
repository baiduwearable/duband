...
/**@brief Function for erasing a flash page.
 *
 * @note This operation record flash page erase request, and will execute right after radio is not active!
 *
 * @param[in]  page_num   Page number to erase.
 *
 * @return     NRF_SUCCESS on success, an error_code otherwise.
...
/**@brief Function for judging the page_num erased finished 
 *
 * @note 
 *
 * @param[in]  page_num   Page number to test erased finishes.
 *
 * @return     
 *            true  : the page_num erased finished
 *            false : the page_num flash still in Q
 */
